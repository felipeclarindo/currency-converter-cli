...
class App:
    def __init__(self) -> None:
        ...
        self.conversor = Conversor(
            moeda_origem=None, moeda_destino=None, valor=None
        )  # Instância do objeto
        self.moedas = {
...
[4] REAL \n"""
                ...
                self.conversor.moeda_origem = lista_moedas[
                    escolha_origem - 1
                ]  # Código da moeda de origem
                self.conversor.moeda_destino = lista_moedas[
                    escolha_destino - 1
                ...
                self.conversor.conversao(
                    self.conversor.moeda_origem, self.conversor.moeda_destino
                )
